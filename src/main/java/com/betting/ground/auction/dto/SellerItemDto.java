...
public class SellerItemDto {
	...
	@Builder
	public SellerItemDto(Long auctionId, String title, Long currentPrice, String imageUrl, LocalDateTime createdAt,
		Duration duration, LocalDateTime endAuctionTime, AuctionStatus auctionStatus) {
