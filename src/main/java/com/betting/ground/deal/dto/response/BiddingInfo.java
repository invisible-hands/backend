...
public class BiddingInfo {
    ...
    @QueryProjection
    public BiddingInfo(Long auctionId, String imageUrl, String title, LocalDateTime bidTime, LocalDateTime createdAt, Duration duration, LocalDateTime endAuctionTime, Long currentPrice, Long myBidPrice, AuctionStatus status) {
