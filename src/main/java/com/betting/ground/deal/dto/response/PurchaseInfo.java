...
public class PurchaseInfo {
    ...
    @QueryProjection
    public PurchaseInfo(Long auctionId, Long dealId, String imageUrl, String title, LocalDateTime createdAt, Duration duration, LocalDateTime endAuctionTime, Long purchasePrice, DealStatus status) {
